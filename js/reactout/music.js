...
function render_music(){
  React.render(  React.createElement(AlbumsView, {data: {id: "albums", ratioW: 40, ratioH: 18, title:"Albums", height: "auto", titleIMG: IMGS.none, backgroundIMG: IMGS.none}}) ,
  document.getElementById('app_music'));
}
function render_video(){
  React.render(  React.createElement(Blog, {data: {id: "vid", ratioW: 40, ratioH: 18, tag: "fwvideo", title:"Videos", height: "600", titleIMG: IMGS.none, backgroundIMG: IMGS.none}, ratioW: 40, ratioH: 18}) ,
...
function render_shows(){
  React.render( React.createElement(Blog, {data: {id: "show", ratioW: 40, ratioH: 30, tag: "fwshows", title:"Shows", height: "auto", titleColor: "#000", titleIMG: IMGS.none, backgroundIMG: IMGS.none}, titleColor: "#000", ratioW: 40, ratioH: 25}) ,
